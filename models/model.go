...
func init() {
	...
	// set default database(注意：如果不加loc=Local，日期时间会比正常时间少了8个小时)
	orm.RegisterDataBase("default", "mysql", "root:root@tcp(127.0.0.1:3306)/ShengXian?charset=utf8&loc=Local")
	// register model
